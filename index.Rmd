...
The figure below displays how many times the concentration of SO2 of each county in 2018 is higher than that in previous years. The bigger the size of the circle, the bigger the times. The figure also shows how far the county is from the center of the fire. 

We can see that in general the closer the county is to the center of the fire, the greater the multiple of the change in concentration of SO2.
...
I use the concentration data in previous years(2013-2017) in each counties to build linear models and predict the estimated concentration in 2018 when there was no Camp Fire. Then I calculated the multiple of the actual concentration in 2018 to the predicted concentration in 2018 in each county. 
